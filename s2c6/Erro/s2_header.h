...
double dist(double *x_n, double dim);
double pdf(double x);
...
void markov_N(double (*pdf)(double x), double a, int n_conf, int m, double r, int dim, double **x_n);
double integra_montecarlo_N(int dim, double **mat, int n, double (*f)(double x));
